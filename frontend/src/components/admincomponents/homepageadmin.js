...
function HomePageAdmin() {
    return (
        <body>
                ...
                <Form.Control placeholder="Please enter name" required='required' width='200px'/>
                </Form.Group>

  <Form.Group controlId="formGridAddress2">
    <Form.Label>Contact Number</Form.Label>
    <Form.Control placeholder="Please Enter Phone Number"  pattern='[7-9]{1}[0-9]{10}' type='phone'/>
  </Form.Group>
