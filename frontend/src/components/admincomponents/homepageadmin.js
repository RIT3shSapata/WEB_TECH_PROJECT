...
function HomePageAdmin() {
  ...
  const createUser = async(e) => {
    e.preventDefault()
    const data = {username: nameRef.current.value, phoneNo:phoneRef.current.value ,password: passwordRef.current.value, flatNo: flatRef.current.value, owned: ownedRef.current.value};
  ...
  return (
    <body>
      ...
      <div>
        <div className='justify-content-lg-center'>ADD A NEW RESIDENT</div>
      </div>
        ...
        <Form onSubmit={createUser}>
          ...
          <Form.Row>
            ...
            <Form.Group as={Col} controlId='formGridZip'>
              ...
              <Form.Control ref={ownedRef} as='select' defaultValue='Owned'>
                <option>Owned</option>
